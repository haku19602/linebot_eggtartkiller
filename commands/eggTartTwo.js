...
export default async (event) => {
  try {
    ...
    $('.card-tag').each(function () {
      if ($(this).find('.card-text').eq(0).text().trim().includes('蛋塔x2')) {
        ...
        // === 修改版面內容
        template.hero.url = 'https://tb-static.uber.com/prod/image-proc/processed_images/579fb1bf4f93d61a8198a739c9be32e8/5954bcb006b10dbfd0bc160f6370faf3.jpeg'
