...
export default async (event) => {
  try {
    ...
    $('.card-tag').each(function () {
      if ($(this).find('.card-text').eq(0).text().trim().includes('蛋塔x12')) {
        ...
        // === 修改版面內容
        template.hero.url = 'https://raw.githubusercontent.com/haku19602/image/main/eggtartx12.jpg'
